/*
 * This is VCSVLocal, a Java library made by Vignesh Nydhruva, that helps run VStats functions on CSV files. 
...
public class VCSVLocal {
     ...
     * @return an array of data that exists in column <strong>col</strong> of the
     *         CSV file located at <strong>filePath</strong>.
     */
    public static String[] getColumnOfStrings(String filePath, int col) {
        File file = new File(filePath);
